...
from syncdiffusion.syncdiffusion_model import SyncDiffusion, SyncDiffusionOmni
...
def main():
    ...
    parser.add_argument('--sd_version', type=str, default='2.0', choices=['1.5', '2.0', '2.1'], help="stable diffusion version")
    ...
    parser.add_argument('--omni', action='store_true', help="use omnidirectional sampling")
    parser.add_argument('--seed', type=int, default=2023)
    parser.add_argument('--pivot', type=str, help="path to style reference image")
    ...
    if args.omni:
        syncdiffusion_model = SyncDiffusionOmni(device, sd_version=args.sd_version)
    else:
